function Table() {
	...
	TClass.init = function(option) {
		...
		Option[id] = {
			...
			headerBgColor: Tool.getValue(option['headerBgColor'], '#A2FD9A'),//表头颜色
			...
			evenBgColor: Tool.getValue(option['evenBgColor'], '#E3F4FD'),//表格行色
			oddBgColor: Tool.getValue(option['oddBgColor'], '#FDF0E6'),//表格行色
